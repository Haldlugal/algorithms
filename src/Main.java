...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            for (int t = 0; t < 200; t++) {
                ...
                tree.insert(new Cat("Cat number " + random, random));
            }
            forest.add(tree);
        }
        ...
        System.out.println("number of unbalanced trees in cat forest: " + unbalancedTrees);
        System.out.println("that is " + unbalancedTrees  / 2.0 + " percent");
    }
    ...
    public static class Tree {
        ...
        public boolean isBalanced() {
            int countHeightLeft = countHeight(root.leftChild);
            int countHeightRight = countHeight(root.rightChild);
            return Math.abs(countHeightLeft - countHeightRight) <= 1;
        }
        ...
        public int countHeight(TreeNode node)
        {
            ...
            {
                int leftHeight = countHeight(node.leftChild);
                int rightHeight = countHeight(node.rightChild);
